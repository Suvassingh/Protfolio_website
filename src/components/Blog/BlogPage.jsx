...
const BlogPage = () => {
  ...
  if (selectedPost) {
    ...
    return (
      <div className="min-h-screen bg-white text-gray-800 font-sans">
        <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 px-[7vw] md:px-[20vw] py-4 flex items-center justify-between">
          <button
            onClick={() => {
              setSelectedPost(null);
              navigate("/blog");
        ...
        <article className="px-[7vw] md:px-[20vw] py-16 max-w-4xl mx-auto">
          {selectedPost.coverImageUrl && (
            <img
              ...
              className="w-full max-h-96 object-cover rounded-2xl mb-10 shadow-md"
            />
          )}
          <div className="flex items-center gap-3 mb-6 flex-wrap">
            <span className="text-xs text-purple-700 bg-purple-100 border border-purple-200 px-3 py-1 rounded-full">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4 mb-12 pb-8 border-b border-gray-200">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-purple-100 text-purple-800 flex items-center justify-center text-sm font-bold">
                S
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-2 rounded-full bg-gray-100 text-gray-700 hover:bg-[#1DA1F2] hover:text-white transition-colors"
              ...
              <button
                ...
                className="p-2 rounded-full bg-gray-100 text-gray-700 hover:bg-[#0077B5] hover:text-white transition-colors"
              ...
              <button
                ...
                className="p-2 rounded-full bg-gray-100 text-gray-700 hover:bg-[#1877F2] hover:text-white transition-colors"
              ...
              <button
                ...
                className="p-2 rounded-full bg-gray-100 text-gray-700 hover:bg-[#25D366] hover:text-white transition-colors"
  ...
  // Posts feed (list view) – white theme
  return (
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <div className="px-[7vw] md:px-[20vw] pt-20 pb-16 text-center">
        <p className="text-xs tracking-widest text-purple-600 uppercase mb-4">
          Thoughts &amp; Writings
        </p>
        <h1
        ...
        {loading ? (
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3].map((n) => (
              <div
                key={n}
                className="bg-gray-50 border border-gray-200 rounded-2xl overflow-hidden animate-pulse"
              >
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {posts.map((post) => (
              <article
                ...
                className="group bg-white border border-gray-200 rounded-2xl overflow-hidden cursor-pointer hover:border-purple-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
              >
                {post.coverImageUrl ? (
                  <img
                  ...
                  <div className="w-full h-48 bg-gradient-to-br from-purple-50 to-gray-100 flex items-center justify-center text-4xl text-purple-300">
                    📝
                  </div>
                )}
                <div className="p-6">
                  ...
                  <h2
                    className="text-lg font-bold text-gray-900 mb-2 group-hover:text-purple-700 transition-colors line-clamp-2"
                    style={{ fontFamily: "'Syne', sans-serif" }}
                  >
                    {post.title}
                  </h2>
